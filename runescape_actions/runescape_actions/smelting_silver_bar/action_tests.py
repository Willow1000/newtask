...
class SmeltSilverBarTest(Test):
    ...
    def main_test(self, action_ordered_steps_current_action):
        from smelting_silver_bar.action_description import highlight_banker
        from runescape_actions.commons.highlight_npc.action_tests import HighlightNpcTest
        from smelting_silver_bar.action_description import withdraw_silver_ore
        from runescape_actions.commons.withdraw_bank.action_tests import WithdrawBankTest
        from smelting_silver_bar.action_description import mark_furnace
        from runescape_actions.commons.object_markers.action_tests import ObjectMarkersTest
        from smelting_silver_bar.action_description import smelt_silver_bar
        from runescape_actions.commons.smelt_item.action_tests import SmeltItemTest
        from smelting_silver_bar.action_description import deposit_silver_bar
        ...
        self.incorporate_test(WithdrawBankTest, withdraw_silver_ore)
        self.incorporate_test(ObjectMarkersTest, mark_furnace)
        self.incorporate_test(SmeltItemTest, smelt_silver_bar)
        self.incorporate_test(DepositBankTest, deposit_silver_bar)
