...
class CookingRawAnchoviesSetup(Test):
    ...
    def main_test(self, action_ordered_steps_current_action):
        from cooking_raw_anchovies_setup.action_description import action_ordered_steps
    ...
    def run(self):
        print('testing CookingRawAnchoviesSetup')
...
if __name__ == "__main__":
    ...
    fire.Fire(CookingRawAnchoviesSetup)
