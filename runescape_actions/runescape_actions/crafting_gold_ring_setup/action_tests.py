...
class CraftGoldRingSetupTest(Test):
    ...
    def main_test(self, action_ordered_steps_current_action):
        from crafting_gold_ring_setup.action_description import action_ordered_steps
        from runescape_actions.commons.craft_ring_setup.action_tests import CraftRingSetupTest
        # you can have the full action test, or test step by step with singular functions
            
        self.incorporate_test(CraftRingSetupTest, action_ordered_steps)

    def run(self):
        print('testing crafting gold ring setup')
        # import everything you need from action_description here
        from crafting_gold_ring_setup.action_description import time_limit, current_action_id, \
...
if __name__ == "__main__":
    ...
    fire.Fire(CraftGoldRingSetupTest)
