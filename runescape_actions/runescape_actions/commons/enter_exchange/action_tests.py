...
class EnterExchangeTest(Test):
    ...
    def run(self):
        print('testing enter exchange')
        # import everything you need from action_description here
        from enter_exchange.action_description import time_limit, current_action_id, \
            app_config_id, context 
        # from action_description import action_ordered_steps
        from enter_exchange.action_description import action_ordered_steps
