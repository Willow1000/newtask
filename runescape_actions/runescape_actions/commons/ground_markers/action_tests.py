...
class GroundMarkersTest(Test):
    ...
    def hooks_setup(self):
        hooks = {
            'shift_right_click': { 
                "check": self.hook_shift_click,
            }, 
        }
        self.set_hooks(hooks)

    def hook_shift_click(self, function_received, args_to_func_received, test_element):
        '''
        ...
        '''
        print('hooking shift_right_click id step') 
    ...
    def run(self):
        ...
        from ground_markers.action_description import time_limit, current_action_id, \
            app_config_id, context 
        # from action_description import action_ordered_steps
        from ground_markers.action_description import action_ordered_steps
