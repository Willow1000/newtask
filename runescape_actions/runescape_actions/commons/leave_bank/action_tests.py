...
class LeaveBankTest(Test):
    ...
    def run(self):
        print("testing leave bank")
        # import everything you need from action_description here
        from leave_bank.action_description import time_limit, current_action_id, \
            app_config_id, context 
        # from action_description import action_ordered_steps
        from leave_bank.action_description import action_ordered_steps
