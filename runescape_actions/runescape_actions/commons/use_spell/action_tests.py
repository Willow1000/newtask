...
class UseSpellTest(Test):
    ...
    def run(self):
        print('testing use spell')
        # import everything you need from action_description here
        from use_spell.action_description import time_limit, current_action_id, \
            app_config_id, context 
        # from action_description import action_ordered_steps
        from use_spell.action_description import action_ordered_steps
