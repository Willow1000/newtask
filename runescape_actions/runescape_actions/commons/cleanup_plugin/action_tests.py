...
class CleanupPluginTest(Test):
    ...
    def run(self):
        print('testing cleanup plugin')
        # import everything you need from action_description here
        from cleanup_plugin.action_description import time_limit, current_action_id, \
            app_config_id, context 
        # from action_description import action_ordered_steps
        from cleanup_plugin.action_description import action_ordered_steps
