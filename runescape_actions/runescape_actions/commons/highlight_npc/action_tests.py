...
class HighlightNpcTest(Test):
    ...
    def run(self):
        print('testing highlight npc')
        # import everything you need from action_description here
        from highlight_npc.action_description import time_limit, current_action_id, \
            app_config_id, context 
        # from action_description import action_ordered_steps
        from highlight_npc.action_description import get_action_ordered_steps
        action_ordered_steps = get_action_ordered_steps()
