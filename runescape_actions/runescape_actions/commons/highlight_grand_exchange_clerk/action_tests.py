...
class HighlightGrandExchangeClerkTest(Test):
    ...
    def run(self):
        ...
        from highlight_grand_exchange_clerk.action_description import time_limit, current_action_id, \
            app_config_id, context 
        # from action_description import action_ordered_steps
        from highlight_grand_exchange_clerk.action_description import action_ordered_steps
...
if __name__ == "__main__":
    ...
    fire.Fire(HighlightGrandExchangeClerkTest)
