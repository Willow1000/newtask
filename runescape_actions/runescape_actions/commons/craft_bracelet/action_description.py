...
current_action_id = "craft_bracelet"
...
step_2 = {
    ...
    "verify": get_action_picture_by_name("bracelet_menu"), 
    "test": [
        {
...
step_4 = {
    "check": get_action_picture_by_name("bracelet_menu"),   
    "verify": get_action_picture_by_name("bracelet_menu"), 
    "verify_args": {
...
deposit_gold_bracelet = get_deposit_all("gold_bracelet", "test_deposit")
action_ordered_steps += deposit_gold_bracelet
...
craft_bracelet = [step_2, step_3, step_4]

def get_craft_bracelet(bracelet, bar):
    deposit_gold_bracelet = get_deposit_all(bracelet, "test_deposit")
    withdraw_gold_bar = get_withdraw_x("26", bar, "test_withdraw")

    step_4 = {
        "check": get_action_picture_by_name(bracelet),   
        "verify": get_action_picture_by_name(bracelet), 
        "verify_args": {
            "reverse_verification": True,
        }, 
        "test": [
    ...
    + move_to_banker + deposit_gold_bracelet + withdraw_gold_bar + [final_step,]
