...
class TeleportTest(Test):
    ...
    def run(self):
        ...
        from teleport_action.action_description import time_limit, current_action_id, \
            app_config_id, context 
        # from action_description import action_ordered_steps
        from teleport_action.action_description import action_ordered_steps
