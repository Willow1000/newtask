...
class EnterBankTest(Test):
    ...
    def run(self):
        ...
        from enter_bank.action_description import time_limit, current_action_id, \
            app_config_id, context 
        # from action_description import action_ordered_steps
        from enter_bank.action_description import action_ordered_steps
