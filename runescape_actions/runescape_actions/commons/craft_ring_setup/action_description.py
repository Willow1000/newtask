...
current_action_id = "craft_ring_setup"
...
# Step 6: Withdraw (Ring Mold x 1)

withdraw_ring_mold = get_withdraw_x("1", "ring_mold", "test_inventory_after_buy")
action_ordered_steps += withdraw_ring_mold
...
def get_craft_ring_setup(bar, mold_image="ring_mold"):
    ...
    withdraw_mold = get_withdraw_x("1", mold_image, "test_inventory_after_buy")
    ...
    + deposit_bars + deposit_coins + withdraw_mold + withdraw_bars + [final_step,]
