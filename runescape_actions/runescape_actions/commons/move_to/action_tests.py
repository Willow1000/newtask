...
class MoveToTest(Test):
    ...
    def hooks_setup(self):
        hooks = {
            'click_next_color': {
                "check": self.hook_click_next_color,
            }, 
        }
        self.set_hooks(hooks)
    
    def hook_click_next_color(self, function_received, args_to_func_received):
        '''
        ...
        '''
        print('hooking right_click_item id step') 
    ...
    def run(self):
        ...
        from move_to.action_description import time_limit, current_action_id, \
            app_config_id, context 
        # from action_description import action_ordered_steps
        from move_to.action_description import action_ordered_steps
