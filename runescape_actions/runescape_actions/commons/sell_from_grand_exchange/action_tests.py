...
class SellFromExchangeTest(Test):
    ...
    def main_test(self, action_ordered_steps_current_action):
        from sell_from_grand_exchange.action_description import enter_exchange
        from runescape_actions.commons.enter_exchange.action_tests import EnterExchangeTest
        from sell_from_grand_exchange.action_description import get_sell_from_exchange_test
        from sell_from_grand_exchange.action_description import leave_exchange
        ...
        self.test(get_sell_from_exchange_test())
        self.incorporate_test(LeaveExchangeTest, leave_exchange)

    def run(self):
        print('testing sell from grand exchange')
        # import everything you need from action_description here
        from sell_from_grand_exchange.action_description import time_limit, current_action_id, \
            app_config_id, context
        # from action_description import sell_from_grand_exchange
        self.full_test(None)
...
if __name__ == "__main__":
    ...
    fire.Fire(SellFromExchangeTest)
