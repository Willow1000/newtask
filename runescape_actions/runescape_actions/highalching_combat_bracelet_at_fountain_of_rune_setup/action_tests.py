...
class HighAlchingCombatBraceletSetup(Test):
    ...
    def main_test(self, action_ordered_steps_current_action):
        from highalching_combat_bracelet_at_fountain_of_rune_setup.action_description import (highlight_clerk, highlight_banker)
        from runescape_actions.commons.highlight_npc.action_tests import HighlightNpcTest

        from highalching_combat_bracelet_at_fountain_of_rune_setup.action_description import buy_items
        from runescape_actions.commons.buy_from_grand_exchange.action_tests import BuyFromGrandExchangeTest

        from highalching_combat_bracelet_at_fountain_of_rune_setup.action_description import (deposit_coins, deposit_combat_bracelet)
        from runescape_actions.commons.deposit_bank.action_tests import DepositBankTest

        from highalching_combat_bracelet_at_fountain_of_rune_setup.action_description import withdraw_combat_bracelet
        ...
        self.incorporate_test(DepositBankTest, deposit_combat_bracelet)
        self.incorporate_test(WithdrawBankTest, withdraw_combat_bracelet)
...
if __name__ == "__main__":
    ...
    fire.Fire(HighAlchingCombatBraceletSetup)
