...
current_action_id = "smelting_silver_bar_setup"
...
# Step 4: Deposit (silver ore x 1000)

deposit_silver_ore = get_deposit_x("1000", "silver_ore_inventory", "test_inventory_after_buy")
action_ordered_steps += deposit_silver_ore
