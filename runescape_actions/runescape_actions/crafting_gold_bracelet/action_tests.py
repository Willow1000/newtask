...
class CraftGoldBraceletTest(Test):
    ...
    def main_test(self, action_ordered_steps_current_action):
        from crafting_gold_bracelet.action_description import action_ordered_steps
        from runescape_actions.commons.craft_bracelet.action_tests import CraftBraceletTest
        # you can have the full action test, or test step by step with singular functions
            
        self.incorporate_test(CraftBraceletTest, action_ordered_steps)
...
if __name__ == "__main__":
    ...
    fire.Fire(CraftGoldBraceletTest)
