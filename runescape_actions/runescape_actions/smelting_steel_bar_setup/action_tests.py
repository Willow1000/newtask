...
class SmeltSteelBarSetupTest(Test):
    ...
    def main_test(self, action_ordered_steps_current_action):
        from smelting_steel_bar_setup.action_description import (highlight_clerk, highlight_banker)
        from runescape_actions.commons.highlight_npc.action_tests import HighlightNpcTest
        from smelting_steel_bar_setup.action_description import buy_items
        from runescape_actions.commons.buy_from_grand_exchange.action_tests import BuyFromGrandExchangeTest
        from smelting_steel_bar_setup.action_description import (deposit_coins, deposit_iron_ore, deposit_coal)
...
if __name__ == "__main__":
    ...
    fire.Fire(SmeltSteelBarSetupTest)
