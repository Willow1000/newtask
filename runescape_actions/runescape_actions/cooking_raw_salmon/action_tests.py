...
class CookingRawSalmon(Test):
    ...
    def main_test(self, action_ordered_steps_current_action):
        ...
        from cooking_raw_salmon.action_description import cook_raw_salmon
        from runescape_actions.commons.cook_fish.action_tests import CookFishTest

        from cooking_raw_salmon.action_description import deposit_cooked_salmon
        from runescape_actions.commons.deposit_bank.action_tests import DepositBankTest

        self.incorporate_test(CookFishTest, cook_raw_salmon)
        self.incorporate_test(DepositBankTest, deposit_cooked_salmon)
