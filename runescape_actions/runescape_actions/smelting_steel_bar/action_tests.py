...
class SmeltSteelBarTest(Test):
    ...
    def main_test(self, action_ordered_steps_current_action):
        from smelting_steel_bar.action_description import highlight_banker
        from runescape_actions.commons.highlight_npc.action_tests import HighlightNpcTest
        from smelting_steel_bar.action_description import withdraw_iron_ore
        from runescape_actions.commons.withdraw_bank.action_tests import WithdrawBankTest
        from smelting_steel_bar.action_description import mark_furnace
        from runescape_actions.commons.object_markers.action_tests import ObjectMarkersTest
        from smelting_steel_bar.action_description import smelt_steel_bar
        from runescape_actions.commons.smelt_item.action_tests import SmeltItemTest
        from smelting_steel_bar.action_description import deposit_steel_bar
        ...
        print("passed highlight banker--------------------------------------------------------")
        self.incorporate_test(WithdrawBankTest, withdraw_iron_ore)
        print("passed withdraw iron ore--------------------------------------------------------")
        self.incorporate_test(ObjectMarkersTest, mark_furnace)
        print("passed mark furnace--------------------------------------------------------")
        self.incorporate_test(SmeltItemTest, smelt_steel_bar)
        print("passed smelt steel bar--------------------------------------------------------")
        self.incorporate_test(DepositBankTest, deposit_steel_bar)
     
    def run(self):
        print('testing smelt bronze bar')
        # import everything you need from action_description here
        from smelting_steel_bar.action_description import time_limit, current_action_id, \
