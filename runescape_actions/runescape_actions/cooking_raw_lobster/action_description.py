...
current_action_id = "cooking_raw_lobster"
app_config_id = "full_rs"  # each action may require a different set of configs from the app itself
context = "rs_ps"  # context to know what profile to use, what is this session related to, etc.

# Step 1: Cook (raw lobster)

updates = [
    {
        "id": "click_fish",
        "check": get_action_picture_by_name("raw_lobster"),
        "verify": get_action_picture_by_name("raw_lobster_selected"),
        "test": [
            {
            "mock_image": get_test_picture_by_name("test_lobster"),  
            },
        ],
        "extra_test_info": {
        "end_mock_image_list": [
            get_test_picture_by_name("test_raw_lobster_selected"),
            ],
        },
    },
    {
        "id": "click_fish_icon",
        "check": get_action_picture_by_name("raw_lobster_icon"), 
        "test": [
            {
...
cook_raw_lobster = get_cook_fish(updates)
action_ordered_steps = cook_raw_lobster

#TODO tirar foto cook_menu

deposit_cooked_lobster = get_deposit_all("cooked_lobster", "test_lobster")
action_ordered_steps += deposit_cooked_lobster   
