...
class SmeltBronzeBarSetupTest(Test):
    ...
    def main_test(self, action_ordered_steps_current_action):
        from smelting_bronze_bar_setup.action_description import (highlight_clerk, highlight_banker)
        from runescape_actions.commons.highlight_npc.action_tests import HighlightNpcTest

        from smelting_bronze_bar_setup.action_description import buy_items
        from runescape_actions.commons.buy_from_grand_exchange.action_tests import BuyFromGrandExchangeTest

        from smelting_bronze_bar_setup.action_description import (deposit_coal, deposit_coins, deposit_iron_ore)
        ...
        self.incorporate_test(DepositBankTest, deposit_coal)
    ...
    def run(self):
        ...
        from smelting_bronze_bar_setup.action_description import time_limit, current_action_id, \
...
if __name__ == "__main__":
    ...
    fire.Fire(SmeltBronzeBarSetupTest)
