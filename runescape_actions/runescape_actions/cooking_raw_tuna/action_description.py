...
cook_raw_tuna = get_cook_fish(updates)
action_ordered_steps = cook_raw_tuna


# Step 8: Deposit cooked tuna (all)

deposit_cooked_tuna = get_deposit_all("cooked_tuna", "test_cooked_tuna")
action_ordered_steps += deposit_cooked_tuna
